...
\begin{enumerate}
	...
	\item Banker's algoritme til håndtering af deadlock - Hvor Banker's algoritme skal implementeres således at der aldrig tildeles ressourcer i et omfang der gør at maskinen løber tør for ressourcer, hvilket medvirker at alle beregninger går i stå fordi alle tråde venter på flere ressourcer (deadlock). \todo{skal der bruges særlige værktøjer i denne opgave?}
\end{enumerate}
