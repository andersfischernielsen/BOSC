...
\texttt{generate_request} og \texttt{generate_release} er modificeret til altid at runde op, når der genereres tilfældige tal. Dette er gjort, da metoden ellers ville køre for evigt indtil den ramte tallet 1.